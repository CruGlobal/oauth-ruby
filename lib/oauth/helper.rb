...
module OAuth
  module Helper
    ...
    def escape(value)
      URI::DEFAULT_PARSER.escape(value.to_s, OAuth::RESERVED_CHARACTERS)
    rescue ArgumentError
      URI::DEFAULT_PARSER.escape(value.to_s.force_encoding(Encoding::UTF_8), OAuth::RESERVED_CHARACTERS)
    end
